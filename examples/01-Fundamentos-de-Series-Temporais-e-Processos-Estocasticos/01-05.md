---
title: "Aula 01 - Slide 04: Dependencia temporal entre observacoes"
output: html_document
---

## Objetivo
Contrastar ruido branco (sem dependencia) com um AR(1) (com dependencia).

## Descricao
Este documento explica o passo a passo do codigo para gerar a figura/resultado associado ao slide.

## Conexao com o PDF
Slide 04, arquivo de saida `figures/01-04.png` (concatena `01-04a.png` e `01-04b.png`).
...
```
## Error in file(filename, "r", encoding = encoding): cannot open the connection to 'https://raw.githubusercontent.com/eogasawara/TSED/refs/heads/main/code/header.R'
```
